  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">小凡AI编程助手</h1>
      </div>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/program-assis')">
        <div class="card-glow"></div>
        <div class="app-icon program-icon">❤️</div>
        <div class="app-info">
          <div class="app-title">小凡AI编程助手</div>
...
// 设置页面标题和元数据
useHead({
  title: '小凡AI超级智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: '小凡AI超级智能体应用平台提供AI编程助手和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI编程助手,AI助手,智能对话,小凡,AI超级智能体,首页'
    }
  ]
})
